...
export default function Footer() {
  return (
    <footer className="py-8">
      <div className="container footer_col px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-4">
            <p className="pb-4 f-heading">Learn More</p>
            <ul>
              {links.map(({ name, link }) => {
                return (
                  <li key={link}>
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-4">
            <p className="pb-4 f-heading">Important Links</p>
            <ul>
