  ...
  return (
    <>
      ...
      <div className='flex items-center mb-4'>
        <img src='https://upload.wikimedia.org/wikipedia/commons/a/ab/Apple-logo.png' alt="" className='w-16' />
      ...
      <div className='mb-8'>
        <p className='text-secondary text-lg mb-1 font-light'><span className='font-medium'>Repairing Date:</span> 12-10-22</p>
        <p className='text-secondary text-lg mb-1 font-light'><span className='font-medium'>Time slot:</span> 01:30 pm</p>
        <p className='text-secondary text-lg mb-1 font-light'>your mobile has <span className='font-medium'>charging and mic</span> issue</p>
      </div>
      <h2 className='text-2xl font-medium text-primary mb-4'>Address Details</h2>
      <div className="mb-8">
        <p className='text-secondary text-lg mb-1 font-light'><span className='font-medium'>Repairing Date:</span> 12-10-22</p>
        <p className='text-secondary text-lg mb-1 font-light'><span className='font-medium'>Time slot:</span> 01:30 pm</p>
      </div>
      <h2 className='text-2xl font-medium text-primary mb-4'>Service Highlights</h2>
      <div className="mb-8">
